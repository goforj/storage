module github.com/goforj/filesystem/examples/rclone_local

go 1.24.4

//replace github.com/goforj/filesystem => ../..
//Point this to your local clone of the add-on (or remove if using the published module)
//replace github.com/goforj/filesystem-rclone => ../../filesystem-rclone

require (
	github.com/goforj/filesystem v0.0.1
	github.com/goforj/filesystem-rclone v0.0.1
)
