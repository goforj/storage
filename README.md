...
| **Context** | [BuildContext](#buildcontext) [ContextPagedStorage](#contextpagedstorage) [ContextPagedStorage.ListPageContext](#contextpagedstorage-listpagecontext) [ContextStorage](#contextstorage) [ContextStorage.CopyContext](#contextstorage-copycontext) [ContextStorage.DeleteContext](#contextstorage-deletecontext) [ContextStorage.ExistsContext](#contextstorage-existscontext) [ContextStorage.GetContext](#contextstorage-getcontext) [ContextStorage.ListContext](#contextstorage-listcontext) [ContextStorage.MakeDirContext](#contextstorage-makedircontext) [ContextStorage.MoveContext](#contextstorage-movecontext) [ContextStorage.PutContext](#contextstorage-putcontext) [ContextStorage.StatContext](#contextstorage-statcontext) [ContextStorage.URLContext](#contextstorage-urlcontext) [ContextStorage.WalkContext](#contextstorage-walkcontext) [CountFilesContext](#countfilescontext) [ListPageResult](#listpageresult) [PagedStorage](#pagedstorage) [PagedStorage.ListPage](#pagedstorage-listpage) |
| **Core** | [CountFiles](#countfiles) [DiskName](#diskname) [Entry](#entry) [Storage](#storage) [Storage.Copy](#storage-copy) [Storage.Delete](#storage-delete) [Storage.Exists](#storage-exists) [Storage.Get](#storage-get) [Storage.List](#storage-list) [Storage.MakeDir](#storage-makedir) [Storage.Move](#storage-move) [Storage.Put](#storage-put) [Storage.Stat](#storage-stat) [Storage.URL](#storage-url) [Storage.Walk](#storage-walk) |
...
### <a id="contextpagedstorage"></a>ContextPagedStorage

ContextPagedStorage exposes context-aware paginated one-level listing.

### <a id="contextpagedstorage-listpagecontext"></a>ContextPagedStorage.ListPageContext
...
### <a id="contextstorage-makedircontext"></a>ContextStorage.MakeDirContext
